...
export var Button = function (props) {
    var _a;
    var className = props.className, disabled = props.disabled, btnType = props.btnType, size = props.size, href = props.href, children = props.children, restProps = __rest(props, ["className", "disabled", "btnType", "size", "href", "children"]);
