...
export var Input = forwardRef(function (props, ref) {
    ...
    var cnames = classNames('godlike-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "godlike-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon }))),
        React.createElement("input", __assign({ ref: ref, className: "godlike-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "godlike-input-group-append" }, append)));
});
