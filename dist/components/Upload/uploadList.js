...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "godlike-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "godlike-upload-list-item", key: item.uid },
